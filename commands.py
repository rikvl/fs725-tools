...
fs725_commands = OrderedDict({
    ...
    "ad0":  Cmd("ad0",    float,      "ADC Spare J204 voltage"),
    "ad1":  Cmd("ad1",    float,      "ADC 24V heater supply voltage divided by 10"),
    "ad2":  Cmd("ad2",    float,      "ADC 24V electronics supply divided by 10"),
    "ad3":  Cmd("ad3",    float,      "ADC Drain voltage to lamp FET divided by 10"),
    "ad4":  Cmd("ad4",    float,      "ADC Gate voltage to lamp FET divided by 10"),
    ...
    "ad9":  Cmd("ad9",    float,      "ADC Photocell IV converter voltage divided by 4"),
    "ad10": Cmd("ad10",   float,      "ADC Case temperature Celsius divided by 100"),
    ...
    "ad14": Cmd("ad14",   float,      "ADC Frequency calibration pot voltage"),
    "ad15": Cmd("ad15",   float,      "ADC Analog ground"),
    # Analog Test (8-bit values)
    "ad16": Cmd("ad16",   float,      "ADC VCXO varactor voltage divided by 4"),
    "ad17": Cmd("ad17",   float,      "ADC VCO varactor voltage divided by 4"),
    "ad18": Cmd("ad18",   float,      "ADC AGC for RF voltage divided by 4"),
